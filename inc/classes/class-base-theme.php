...
class BASE_THEME {
	...
	public function setup_theme() {
		...
		load_theme_textdomain( 'base-theme', BASE_THEME_TEMPLATE_DIR . '/languages' );
	...
	public function add_read_more_link() {
		...
		return sprintf( '<a class="moretag" href="%s">%s</a>', get_permalink( $post->ID ), esc_html__( 'Read More', 'base-theme' ) );
