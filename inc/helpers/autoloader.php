...
namespace Base_Theme\Inc\Helpers;
...
function autoloader( $resource = '' ) {
	...
	if ( 'inc' === $path[0] ) {
		...
		$resource_path = sprintf( '%s/inc/%s/%s.php', untrailingslashit( BASE_THEME_TEMPLATE_DIR ), $directory, $file_name );
...
spl_autoload_register( '\Base_Theme\Inc\Helpers\autoloader' );
